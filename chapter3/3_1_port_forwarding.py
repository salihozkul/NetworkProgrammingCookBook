...
if __name__ == '__main__':
    ...
    local_host, remote_host = give_args.local_host, give_args.remote_host
    local_port, remote_port = give_args.local_port, give_args.remote_port
